...
public class ReadEmailInbox {
	...
	public static void main(String[] args) {
		...
		String host ="pop.secureserver.net";// "pop.googlemail.com";// 
		String mailStoreType = "pop3";
		String username = "kiranjobs007@gmail.com";// change accordingly
		String password = "8904268137";// change accordingly
